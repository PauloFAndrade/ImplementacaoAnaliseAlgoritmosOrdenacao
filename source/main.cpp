...
int main( int argc, char * argv[] ){
    ...
    //2. Crie um arranho I com valores de 0 até n − 1, onde n é o tamanho do arranjo A.
    ...
    //Faça um laço de i = 0 até p = d(0.25 ∗ n)e, com o i sendo incrementado de 2 em 2, trocando A[I[i]] com A[I[i + 1]].

    // Cenarios:
    //std::vector<value_type> I;
    //size_type sz = 1000;
    ...
    //std::shuffle(I.begin(), I.end(), gen);

    
    //////////////SCENARIO 1//////////////
    std::ofstream arquivo1( "lib/times/non_increasing.txt" );
    ...
    while(atual<=max){
        ...
        for(int i{0};i<ciclo;i++){
            ...
            //std::cout << "]\n\n";
            sorting = backup;
            //std::cout << "Vetor Sorting: [ ";
            //for(int i{0};i<atual;i++){
            //    std::cout << sorting[i] << " ";
            //}   
            //std::cout << "]\n\n";
            //std::cout << "Vetor Backup: [ ";
            //for(int i{0};i<atual;i++){
            //    std::cout << backup[i] << " ";
            //}   
            //std::cout << "]\n\n";
    ...
    std::ofstream arquivo2( "lib/times/non_decreasing.txt" );
    index = 1;
    atual = 400;
    while(atual<=max){
        std::cout << "============================ CICLO "<<index<<"/"<<(max/400)<<" =============================\n";
    ...
    arquivo2.close();
    //////////////SCENARIO 3//////////////
    std::ofstream arquivo3( "lib/times/all_random.txt" );
    index = 1;
    atual = 400;
    while(atual<=max){
        std::cout << "============================ CICLO "<<index<<"/"<<(max/400)<<" =============================\n";
        ...
        for(int i{0};i<ciclo;i++){
            //CALCULANDO TEMPO DO ALGORITMO
            std::cout << i << " ";
            //std::cout << "Vetor Para Ordenar (SELECTION): [ ";
            //for(int i{0};i<atual;i++){
            //    std::cout << sorting[i] << " ";
            //}   
            //std::cout << "]\n\n";
            ...
            std::chrono::duration<double> time9 = end9 - start9;
            sum[1] += std::chrono::duration <double, std::milli> (time9).count();
            //std::cout << "Vetor Ordenado:(SELECTION) [ ";
            //for(int i{0};i<atual;i++){
            //    std::cout << sorting[i] << " ";
            //}   
            //std::cout << "]\n\n";
            sorting = backup;
            //std::cout << "Vetor Sorting (SELECTION): [ ";
            //for(int i{0};i<atual;i++){
            //    std::cout << sorting[i] << " ";
            //}   
            //std::cout << "]\n\n";
            //std::cout << "Vetor Backup (SELECTION): [ ";
            //for(int i{0};i<atual;i++){
            //    std::cout << backup[i] << " ";
            //}   
            //std::cout << "]\n\n";
    ...
    arquivo3.close();
    //////////////SCENARIO 4//////////////
    std::ofstream arquivo4( "lib/times/sorted75.txt" );
    index = 1;
    atual = 400;
    while(atual<=max){
        std::cout << "============================ CICLO "<<index<<"/"<<(max/400)<<" =============================\n";
    ...
    arquivo4.close();
    //////////////SCENARIO 5//////////////
    std::ofstream arquivo5( "lib/times/sorted50.txt" );
    index = 1;
    atual = 400;
    while(atual<=max){
        std::cout << "============================ CICLO "<<index<<"/"<<(max/400)<<" =============================\n";
    ...
    arquivo5.close();
    //////////////SCENARIO 6//////////////
    std::ofstream arquivo6( "lib/times/sorted25.txt" );
    index = 1;
    atual = 400;
    while(atual<=max){
        std::cout << "============================ CICLO "<<index<<"/"<<(max/400)<<" =============================\n";
